...
Matriz4f::Matriz4f(char c, vector<double> param)
: filas(4)
{
	Inicializar(c, param);
}
...
Matriz4f::Matriz4f(vector<double> param)
: filas(4)
{
	Inicializar(param);
}
...
// Inicializa la matriz
void Matriz4f :: Inicializar(char c, vector<double> param)
{
	// Reservar memoria
	ReservaMemoria();
...
// Inicializa la matriz
void Matriz4f :: Inicializar(vector<double> param)
{
	// Reservar memoria
	ReservaMemoria();
